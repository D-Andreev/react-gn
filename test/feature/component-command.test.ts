...
import {ASCII_ART, CLI_NAME, NEW_COMPONENT_MESSAGE} from '../../src/constants';
...
describe('component command', () => {
    ...
    describe('when I do not provide component name', () => {
        it('shows the help', () => {
            const result = execSync(`${CLI_NAME} component`);
        ...
        describe('when template path is not provided', () => {
            it('shows an error message', () => {
                ...
                const result = execSync(
                    `cd ${myDir} && ${CLI_NAME} component --name ${componentName}`
                );
